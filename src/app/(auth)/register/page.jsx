        ...
        <div className="relative z-10 hidden min-h-180 lg:block">
          <div className="mt-8 max-w-75 xl:mt-10 xl:max-w-md">
            ...
            <p className="mt-5 text-sm leading-6 text-gray-200 xl:text-base xl:leading-7">
              Create your account and enjoy a seamless shopping or selling
              experience with us.
            </p>
            ...
            <div className="mt-8 space-y-5">
              ...
              <div className="flex items-start gap-3 xl:gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-5 text-gray-300">
                    Shop products from stores available on Bazar-e-Pak.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 xl:gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-5 text-gray-300">
                    Create and manage your store and products.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 xl:gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-5 text-gray-300">
                    Create your account and get started with Bazar-e-Pak.
                  </p>
                </div>
              </div>
            </div>
