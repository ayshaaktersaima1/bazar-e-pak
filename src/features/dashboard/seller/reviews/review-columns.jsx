...
const ReviewColumns = ({ onDelete } = {}) => [
  {
    ...
    render: (review) => (
      <div>
        ...
        <p className="text-xs text-zinc-400">{review.userId || "N/A"}</p>
      </div>
    ),
  },
  {
    ...
    render: (review) => (
      <div className="flex items-center gap-1">
        <Star size={15} fill="currentColor" className="text-[#D9A928]" />

        <span className="font-semibold text-[#001B08]">{review.rating}/5</span>
      </div>
    ),
  },
  {
